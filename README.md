...
- [Game Design Document and Soon to Be Code Documentation](https://github.com/SteveNield/combat-game/wiki)
...
Once we have a full working client. I will work on making sure fresh pulls work without any of this nonsense. But for now, just use this work around. I just don't want to break anything so close to a stable release.
